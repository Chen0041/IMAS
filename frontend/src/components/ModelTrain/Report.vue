        ...
        <div>
          <el-card class="box-card">
            ...
            >
              ...
              <el-table-column prop="state" label="Status" width="125" sortable>
              </el-table-column>
              <el-table-column
                  prop="data"
                  label="Dataset"
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-button type="danger" size="mini" @click="deleteTask(scope.row.name)">Delete</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-card>
    ...
    getAllReports(){
      this.$axios({
        ...
        for(var i=0;i<this.tableData1.length;i++){
          if(this.tableData1[i].state==1){
            this.tableData1[i].state='done'
          }else if(this.tableData1[i].state==0){
            this.tableData1[i].state='running'
          }else{
            this.tableData1[i].state='failed'
          }

        ...
        methods: {
            ...
            getModelInfo(modelId) {
                this.$axios({
                    ...
                    console.log("/modelCategory/model/' + modelId");
                    console.log(res.data);
                ...
                this.$axios({
                    ...
                    for (let metric in res.data) {
                        if (res.data.hasOwnProperty(metric)) {
                            ...
                            // console.log("metric id and name:");
                            // console.log(res.data[metric].id);
                            // console.log(res.data[metric].metricName);
                        }
                    }
                    // console.log(models)
                    // console.log(metrics)
